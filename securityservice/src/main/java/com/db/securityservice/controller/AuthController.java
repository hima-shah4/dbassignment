...
import com.db.securityservice.model.JwtResponse;
...
public class AuthController {
    ...
    private void doAuthenticate(String applicationId, String password) {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(applicationId, password);
        try {
